    ...
    <div class="container">
      ...
      <section class="pt-5">
        ...
        <div class="wow fadeIn">
          ...
          <!--Section description-->
          <p class="text-center">Renting, also known as hiring or letting, is an agreement where a payment is made for the temporary use of a good, service or property owned by another.
            and apps. </p>
          <p class="text-center mb-5 pb-5"> A video rental shop/store is a physical business that rents home videos such as movies and prerecorded TV shows.</p>
        </div>
        <!-- Heading & Description -->
        ...
        <div class="row wow fadeIn">
          ...
          <div class="col-lg-5 col-xl-4 mb-4">
            ...
            <div class="view overlay rounded z-depth-1-half">
              ...
              <img src="/img/video_rental_banner.jpg" class="img-fluid"
                alt="">
              </div>
            </div>
          </div>
        ...
        <div class="row wow fadeIn">
          ...
          <div class="col-lg-5 col-xl-4 mb-4">
            <!--Featured image-->
            <div class="view overlay rounded z-depth-1">
              <img src="img/video_rental_banner.jpg" class="img-fluid" alt="">
              <a href="#" target="_blank">
                <div class="mask rgba-white-slight"></div>
              </a>
            </div>
